...
# @patrtorg/quam-iure-deserunt

[![npm version](https://img.shields.io/npm/v/@patrtorg/quam-iure-deserunt.svg)](https://www.npmjs.com/package/@patrtorg/quam-iure-deserunt)
[![Build Status](https://github.com/patrtorg/quam-iure-deserunt/actions/workflows/build.yml/badge.svg)](#)
[![contributions welcome](https://img.shields.io/badge/contributions-welcome-brightgreen.svg?style=flat)](https://github.com/patrtorg/quam-iure-deserunt/issues)
[![Downloads](https://img.shields.io/npm/dm/@patrtorg/quam-iure-deserunt.svg)](https://img.shields.io/npm/dm/@patrtorg/quam-iure-deserunt.svg)
[![FOSSA Status](https://app.fossa.com/api/projects/git%2Bgithub.com%2Faravindnc%2F@patrtorg/quam-iure-deserunt.svg?type=shield)](https://app.fossa.com/projects/git%2Bgithub.com%2Faravindnc%2F@patrtorg/quam-iure-deserunt?ref=badge_shield)
![GitHub commit activity](https://img.shields.io/github/commit-activity/m/aravindnc/@patrtorg/quam-iure-deserunt)
![npms.io](https://img.shields.io/npms-io/maintenance-score/@patrtorg/quam-iure-deserunt)
![npms.io](https://img.shields.io/npms-io/quality-score/@patrtorg/quam-iure-deserunt)
...
```sh
npm install @patrtorg/quam-iure-deserunt
```
...
const mongoosePaginate = require('@patrtorg/quam-iure-deserunt');
...
Prior to version `1.5.0`, types need to be installed from [DefinitelyTyped](https://github.com/DefinitelyTyped/DefinitelyTyped/tree/master/types/@patrtorg/quam-iure-deserunt).

To declare a `PaginateModel` in your Typescript files:

```ts
import mongoose from 'mongoose';
import paginate from '@patrtorg/quam-iure-deserunt';
...
```javascript
const { PaginationParameters } = require('@patrtorg/quam-iure-deserunt');
...
```javascript
var mongoosePaginate = require('@patrtorg/quam-iure-deserunt');
